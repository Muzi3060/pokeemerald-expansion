...
// Campaign default: stronger move selection and switching without omniscience.
#define AI_FLAG_ENHANCED_TRAINER      (AI_FLAG_BASIC_TRAINER | AI_FLAG_SMART_SWITCHING | AI_FLAG_PP_STALL_PREVENTION)
